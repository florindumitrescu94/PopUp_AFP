//
// ASCOM.PopUpAutoFlatPanel.CoverCalibrator Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server2
    {
        ...
        private static string localServerAppId = "{e116ed8d-a013-478a-a52f-58840df3a75c}"; // Our AppId
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "PopUpAutoFlatPanel.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "PopUpAutoFlatPanel Local Server Thread";
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.PopUpAutoFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.PopUpAutoFlatPanel.CoverCalibrator was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.PopUpAutoFlatPanel.CoverCalibrator was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.PopUpAutoFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.PopUpAutoFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.PopUpAutoFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.PopUpAutoFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
