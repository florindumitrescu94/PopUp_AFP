    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e) // OK button event handler
        {
            ...
            else // A valid COM port has been selected
            {
                ...
                CoverCalibratorHardware.openPosition = (string)openPos.Text;
                CoverCalibratorHardware.closedPosition = (string)closedPos.Text;
                tl.LogMessage("Setup OK", $"New configuration values - COM Port: {comboBoxComPort.SelectedItem} - Open Position: {openPos.Text} - Closed Position: {closedPos.Text}");
            }
        }
        ...
        private void InitUI()
        {
            ...
            openPos.Text = CoverCalibratorHardware.openPosition;
            closedPos.Text = CoverCalibratorHardware.closedPosition;
